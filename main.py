...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        ...
        "Clicknext ai team ที่มาจัดงาน BUU-Bootcamp-2024 ที่มีนักศึกษาจำนวน 100 ล้านคน มีพี่ชายปาล์มใส่แว่น กับพี่แว่นเจ๋งอีกคน และพี่สาวดาวที่นั่งปั่นงาน กับ พี่ออยตัวเล็กๆ เป็นBA หัวหน้าทีมสุดหล่อพี่ชวนส์",
        "พี่ชายปาล์ม คือ คน ที่ผมถามไปเมื่อกี้เลย",
