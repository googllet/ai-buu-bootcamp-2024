...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        ...
        "ทีมงานทั้งหมด 5 คน มี พี่เจ๋ง พี่ดาว พี่ออย พี่ชวนส์ พี่ปาล์ม ครับ"
        "พี่เจ๋ง คือ คนที่ใส่เป็นเป็นพิธีกรเฮฮา,
        "พี่ดาว คือ คนที่นั่งปั่นงานอยู่แล้วก็เป็น BA",
        "พี่ออย คือ คนที่ตัวเล็กๆ",
        "พี่ชวนส์ คือ คนที่พี่ดาวบอกว่าตับแข็ง",
        "พี่ปาล์ม คือ คนที่ผมถามไปเมื่อกี้เลย",
